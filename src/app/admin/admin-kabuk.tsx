...
/**
 * Panelin istemci tarafı kabuğu: oturum, menü, kaydedilmemiş değişiklik koruması.
 * `layout.tsx` sunucu bileşeni (manifest ve başlık bilgisi için); bu dosyayı sarar.
 */
export function AdminKabuk({ children }: { children: React.ReactNode }) {
  ...
  const cikisDugmesi = (
    <>
      <YukleDugmesi gorunum="panel" panel />
